...
############################################
# Müşterileri segmentlere ayırarak
# hangi segmente hangi karar alınabileceği üzerine pazarlama stratejileri geliştirilerek
# pazarlama departmanına aksiyon aldırılabilir.
############################################
...
############################################
# Örnek bir segmentin çıktısının alınması :
